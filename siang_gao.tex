...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemCustom{
          Improved \href{https://blog.linkedin.com/2018/september/10/unveiling-a-new-linkedin-groups-experience-a-shared-space-to-build-community}{Groups product} and enabled group admins to separate group privacy and membership settings. Implemented new logic in voyager api and multiproducts using Java, and added configurations to settings database
        }
        \resumeItemCustom{
