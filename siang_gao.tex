...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemCustom{
          Improved \href{https://blog.linkedin.com/2018/september/10/unveiling-a-new-linkedin-groups-experience-a-shared-space-to-build-community}{Groups product} across front end, middle tier and back end,
          modified RESTful APIs and
          \href{https://engineering.linkedin.com/blog/2017/01/great-tools-for-engineers--refactoring-across-multiple-code-repo}{multiproducts} in Java, tested code with Mockito and curl calls, and added configurations to Anet and Espresso database
        }
        \resumeItemCustom{
        Proposed different solutions to problems, discussed and coordinated with multiple teams for implementation
            % Proposed different technical solutions to problems and discussed their pros and cons with colleagues from different teams
        }
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        %   Developed a K-12 education website with React,
    ...
    \resumeSubheading
      {Peking University}{Beijing, China}
      {Undergraduate Research Assistant}{Nov 2015 -- Apr 2018}
      \resumeItemListStart
        \resumeItemCustom{
            Researched on data stream processing, network traffic measurement and big data analysis, designed and conducted several research projects on Bloom filters and Sketches
        }
        % \resumeItemCustom{
        %     Designed and conducted several research projects on Bloom filters and Sketches
        % }
        \resumeItemCustom{
            Supervised other students in paper writing, experiment designing, coding and figure plotting
        }
        % \resumeItemCustom{
    ...
    \resumeSubItem{Twitter Analytics Web Service}
      {
        ...
        %ranked first in class final live test, 
        having HBase and MySQL as back end,
        whose 
        %schemas are highly optimized and 
    ...
    % fake item. just want the indent
      ...
      \resumeItemListStart
        \resumeItemCustom{
            ...
            % TongYang, \underline{Siang Gao}, Zhouyi Sun, Yufei Wang, Yulong Shen, Xiaoming Li. Diamond Sketch: Accurate Per-flow Measurement for Big Streaming Data. To appear in TPDS 2019.
            }
        }
        \resumeItemCustom{
            ...
            % Zhouyi Sun, \underline{Siang Gao}, Bingqing Liu, Yufei Wang, Tong Yang, Bin Cui. Magic Cube Bloom Filter: Answering Membership Queries for Multiple Sets. To appear in Bigcomp 2019.
            }
        }
      \resumeItemListEnd
    \resumeSubHeadingListEnd
