  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItemCustom{
          Wrote a design document for my project, and held several meetings with people from different teams to discuss it
        }
        \resumeItemCustom{
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{QryEval}
      {Search engine for structured queries written in Java. It supports ranking algorithms like
        Unranked/Ranked Boolean, Indri, and BM25. It uses pseudo relevance feedback, learning to rank, and diversification to improve the result}
