...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemCustom{
          Worked on \href{https://blog.linkedin.com/2018/september/10/unveiling-a-new-linkedin-groups-experience-a-shared-space-to-build-community}{Groups product} improvements across front end, middle tier and back end;
          modified RESTful APIs and
          \href{https://engineering.linkedin.com/blog/2017/01/great-tools-for-engineers--refactoring-across-multiple-code-repo}{multiproducts} in Java, wrote tests with Mockito, and added configurations to Anet and Espresso database
        }
        \resumeItemCustom{
...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Technologies}
      {React, Vue.js, Django, AWS, GCP, \LaTeX, Git, SVN, HTML, CSS, Mockito, AEther}
  \resumeSubHeadingListEnd
